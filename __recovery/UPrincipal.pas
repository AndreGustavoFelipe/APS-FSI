...
type
  TFormPrincipal = class(TForm)
    ...
    queryAgendamentosTIPO_VEICULO: TStringField;
    queryAgendamentosTIPO_LAVACAO: TStringField;
    ...
    cxGridAgendamentosTIPO_LAVACAO: TcxGridDBColumn;
    cxGridAgendamentosSTATUS: TcxGridDBColumn;
    cxGridAgendamentosID1: TcxGridDBColumn;
    cxGridAgendamentosID_CLIENTE1: TcxGridDBColumn;
    cxGridAgendamentosID_FUNCINARIO1: TcxGridDBColumn;
    cxGridAgendamentosDATA_AGENDAMENTO1: TcxGridDBColumn;
    cxGridAgendamentosDATA_AGENDADA1: TcxGridDBColumn;
    cxGridAgendamentosHORA_AGENDAMENTO1: TcxGridDBColumn;
    cxGridAgendamentosHORA_ENTREGA1: TcxGridDBColumn;
    cxGridAgendamentosPLACA1: TcxGridDBColumn;
    cxGridAgendamentosTIPO_VEICULO1: TcxGridDBColumn;
    cxGridAgendamentosTIPO_LAVACAO1: TcxGridDBColumn;
    cxGridAgendamentosSTATUS1: TcxGridDBColumn;
